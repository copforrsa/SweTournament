...
function safeApply(){try{networkBanner();protectExternalLinks();hardenForms();stabilizePayment()}catch(e){console.warn('SWÉ stabilité 42.83',e)}}
...
[500,1500,3500].forEach(ms=>setTimeout(safeApply,ms));document.addEventListener('swe:rendered',()=>setTimeout(safeApply,40));window.addEventListener('pageshow',()=>setTimeout(safeApply,80));
})();