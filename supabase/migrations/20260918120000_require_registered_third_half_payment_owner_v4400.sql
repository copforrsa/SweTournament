-- Le propriétaire du lien personnel doit faire partie des inscrits actifs.
-- Cette règle complète la séparation existante des trois rôles Glacière.
...
begin
  ...
  if p_payment_player_id is not null and not v_payment_registered then
    raise exception 'Le responsable du lien doit être inscrit au tournoi';
  end if;
