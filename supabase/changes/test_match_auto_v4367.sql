...
;
drop function public.super_admin_test_match_action(uuid,text,uuid,uuid);
create or replace function public.super_admin_test_match_action(
 p_match_id uuid,p_action text,p_scorer_id uuid default null,p_assister_id uuid default null,
 p_goal_id uuid default null,p_home_score integer default null,p_away_score integer default null
)
...
revoke all on function public.super_admin_test_match_action(uuid,text,uuid,uuid,uuid,integer,integer) from public,anon;
grant execute on function public.super_admin_test_match_action(uuid,text,uuid,uuid,uuid,integer,integer) to authenticated;
