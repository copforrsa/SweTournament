...
function paintMatches(){if(quickAssistActive())return;try{sortMatches();if(typeof renderMatches==='function')renderMatches();if(typeof renderHome==='function')renderHome();document.dispatchEvent(new Event('swe:rendered'));}catch(e){console.warn('SWÉ matchs 42.84',e)}}
