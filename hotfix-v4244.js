...
async function purgeLegacyClient(){
 try{
  const k='swe-legacy-cache-cleaned-v4335';
...
async function boot(){
 ...
 loadCss('/desktop-layout-v4328.css?v=4335','desktop-layout-v4328');
 loadCss('/player-photo-v4333.css?v=4335','player-photo-v4333');
 ...
 loadCss('/player-entry-layout-v4330.css?v=4335','player-entry-layout-v4330');
