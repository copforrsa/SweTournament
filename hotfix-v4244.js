...
async function boot(){
 ...
 await load('/match-extras-v4306.js?v=5021-auto-circuit','match-extras-v4306');await load('/match-archive-v5046.js?v=5046','match-archive-v5046');await load('/tournament-king-config-v4306.js?v=4377','tournament-king-config-v4306');await load('/tournament-creation-flow-v5048.js?v=5049-validation','tournament-creation-flow-v5048');await load('/live-enhance-v4306.js?v=4377','live-enhance-v4306');await load('/match-realtime-v4304.js?v=4377','match-realtime-v4361');await load('/match-tab-recovery-v4355.js?v=4377','match-tab-recovery-v4363');await load('/match-refresh-guard-v4361.js?v=4377','match-refresh-guard-v4361');await load('/public-registration-lock-v4307.js?v=4377','public-registration-lock-v4307');
