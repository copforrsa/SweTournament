...
function mount(ctx){
 ...
 function update(){
  ...
  if(isClosed){E('publicGuestFields')?.classList.add('hidden');E('publicJoin')?.parentElement?.classList.add('hidden');E('chooseTeamMode').disabled=true;}else{E('publicGuestFields')?.classList.remove('hidden');E('publicJoin')?.parentElement?.classList.remove('hidden');E('chooseTeamMode').disabled=false;}
