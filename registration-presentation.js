...
function mount(ctx){
 ...
 function update(){
  ...
  if(king){
   ...
   const plannedTeams=Math.max(3,Math.min(7,Number(t.generated_team_count||0)||Math.round(Number(t.max_players||0)/Math.max(2,Number(t.team_size||5)))||3));
   const conquestPaths={
