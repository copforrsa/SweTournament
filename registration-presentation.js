...
function mount(ctx){
 ...
 ['publicSeasonScorers','publicSeasonAssists'].forEach(id=>{const card=E(id)?.closest('.card');if(card){card.classList.add('sp-card');E('registrationSeasonRankings').append(card)}});
