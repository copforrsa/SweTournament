Warning: truncated output (original token count: 140807)
Total output lines: 6811
  ...
  if($('#myPlayerGroups')){
    ...
    if(S.workspace&&(isAdmin()||isCoorg())){
      ...
      if(linkedPlayer){
        ...
        groupHtml='<div class="player swe-self-link-card"><div style="flex:1"><b>🔗 Relier mon compte organisateur à mon membre joueur</b><div class="muted">Choisis ton nom dans ce groupe. Ton ID SWÉ '+esc(p.public_player_id)+' suivra alors automatiquement tes inscriptions aux tournois en cours et futurs.</div><div class="row" style="mar…90807 tokens truncated…mount,p_contribution_item:contributionItem});
