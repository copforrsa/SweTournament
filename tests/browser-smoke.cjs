  ...
  return {
   ...
   rpc:async(name,args)=>{
    ...
    if(name==='super_admin_get_coorganizer_billing_v1')return {data:[
      ...
      {workspace_id:ids.current,workspace_name:'Groupe du dimanche',organizer_email:'orga@example.invalid',invite_id:fakeId(399),coorganizer_email:'gift-pending@example.invalid',member_status:'invited',payment_status:'gifted',payment_updated_at:'2026-09-13T09:57:00Z'},
