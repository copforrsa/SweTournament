...
function render(data){
 ...
 if(titles){
  ...
  const winner=rows[0],king=[...kingStats.values()].sort((a,b)=>b.points-a.points||(b.gf-b.ga)-(a.gf-a.ga)||b.gf-a.gf||a.name.localeCompare(b.name,'fr'))[0];
  titles.innerHTML=(winner?'<div class="live-title"><small>🏆 VAINQUEUR DU TOURNOI</small><div class="swe-award-name"><span class="swe-award-emblem" aria-hidden="true"><svg viewBox="0 0 80 80" fill="none"><path d="M25 14h30v19c0 14-9 22-15 22s-15-8-15-22V14Z" fill="currentColor"/><path d="M25 20H13v10c0 10 7 16 17 16M55 20h12v10c0 10-7 16-17 16M40 54v12M27 69h26" stroke="currentColor" stroke-width="6" stroke-linecap="round"/><path d="m40 22 3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 3-6Z" fill="#102139"/></svg></span><b>'+esc(winner.name)+'</b></div><div class="king-match-count"><strong>'+winner.v+'</strong><span>victoire'+(winner.v>1?'s':'')+' pendant le tournoi</span></div><span>'+winner.pts+' pts · '+winner.v+' victoire'+(winner.v>1?'s':'')+' · '+winner.n+' nul'+(winner.n>1?'s':'')+'</span></div>':'')+(king?'<div class="live-title king"><small>👑 ROI DU TERRAIN · CARREFOUR</small><div class="swe-award-name"><span class="swe-award-emblem" aria-hidden="true"><svg viewBox="0 0 80 80" fill="none"><path d="m14 25 15 14 11-22 11 22 15-14-7 32H21l-7-32Z" fill="currentColor"/><path d="M23 64h34" stroke="currentColor" stroke-width="6" stroke-linecap="round"/><circle cx="14" cy="22" r="4" fill="currentColor"/><circle cx="40" cy="14" r="4" fill="currentColor"/><circle cx="66" cy="22" r="4" fill="currentColor"/><path d="m40 36 5 7-5 7-5-7 5-7Z" fill="#102139"/></svg></span><b>'+esc(king.name)+'</b></div><div class="king-match-count"><strong>'+king.played+'</strong><span>match'+(king.played>1?'s':'')+' disputé'+(king.played>1?'s':'')+' sur les Terres du Roi</span></div><span>'+king.points+' pt'+(king.points>1?'s':'')+' · '+king.wins+' victoire'+(king.wins>1?'s':'')+(king.draws?' · '+king.draws+' nul'+(king.draws>1?'s':''):'')+'</span></div>':'');
 }
